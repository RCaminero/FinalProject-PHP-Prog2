            ...
            <div class="row">   
                <div class="col-lg-12 text-right">
                    <div class="pagination__option">
                        ...
                        <a href="./textiles.php"><i class="fa fa-angle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="section-title">
                        <h4 id="termos">Termos</h4>
                    </div>
                    <div class="row">
                        <?php
                            $resultado = $link ->query("SELECT * FROM articulo WHERE Categoria_articulo_id_categoria_articulo = 2 ORDER BY Id_articulo DESC") or die("ERROR");
