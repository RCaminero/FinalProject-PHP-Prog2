            ...
            <div class="row">   
                ...
                <div class="col-lg-12">
                    <div class="section-title">
                        <h4 id="tazas">Regalos</h4>
                    </div>
                    <div class="row">
                        <?php
                            $resultado = $link ->query("SELECT * FROM articulo WHERE Categoria_articulo_id_categoria_articulo = 5 ORDER BY Id_articulo DESC") or die("ERROR");
